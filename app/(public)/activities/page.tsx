              ...
              return (
                ...
                >
                  ...
                  <div className="event-card-body">
                    <div>
                      <p className="text-xs text-orange-500 font-bold">{new Date(activity.startDateTime).toLocaleString(undefined, { weekday: 'short', month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}</p>
                    ...
                    <div className="flex justify-between items-center border-t border-white/5 pt-2 mt-1">
                      ...
                      <Link className="text-xs text-orange-400 font-bold hover:underline" href={`/events/${activity.id}`}>
                        Open Activity &rarr;
                      </Link>
                    </div>
                  </div>
