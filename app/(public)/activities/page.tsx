                      ...
                      <div className="event-card-face event-card-front">
                        ...
                        <div className="event-card-body">
                          ...
                          <div className="event-card-actions">
                            ...
                            <button className="edit-card-button" type="button" onClick={(clickEvent) => { clickEvent.stopPropagation(); router.push(`/events/${activity.id}`); }}>
                              <Pencil size={14} /> Edit
                            </button>
                          </div>
                        </div>
          ...
          <div className="split-view-map listing-map-panel">
            ...
            <div className="map-stage">
              <LocationPickerMap
                ...
                label={`${selectedActivity.title} map`}
                readOnly
              />
